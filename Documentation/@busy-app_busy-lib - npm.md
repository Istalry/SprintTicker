...
0.17.0 • Public • Published 21 days ago

-   [Readme](https://www.npmjs.com/package/@busy-app/busy-lib?activeTab=readme)
-   [Code Beta](https://www.npmjs.com/package/@busy-app/busy-lib?activeTab=code)
-   [2 Dependencies](https://www.npmjs.com/package/@busy-app/busy-lib?activeTab=dependencies)
-   [0 Dependents](https://www.npmjs.com/package/@busy-app/busy-lib?activeTab=dependents)
-   [30 Versions](https://www.npmjs.com/package/@busy-app/busy-lib?activeTab=versions)

# busylib

[![node version](https://camo.githubusercontent.com/fef4ef1ec3b1619d615f7481c99fe4c1291891ffc24aea15387e21ca3acb7f8e/68747470733a2f2f696d672e736869656c64732e696f2f6e6f64652f762f253430627573792d617070253246627573792d6c69623f636f6c6f723d363663633333267374796c653d666c6174)](https://nodejs.org) [![license](https://camo.githubusercontent.com/c7862ba0eb2baec379325adbb3bb433eb8c7448c78750bbc0e953fb1b0bda049/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f6c2f40627573792d6170702f627573792d6c69623f636f6c6f723d324237464646267374796c653d666c6174)](https://github.com/busy-app/busylib-ts/blob/HEAD/LICENSE)
...
-   **HTTP error** (4xx/5xx) - a custom error with `status`, `statusText`, and the parsed `body` attached, plus a human-readable `message`
-   **Timeout** - a `DOMException` with `name === 'TimeoutError'` (the default timeout is 3000ms; see [Request options](#request-options))
...
You can set up remote proxy access to send requests to your BUSY Bar from anywhere in the world. This requires an API token, issued at [https://cloud.busy.app/api-tokens](https://cloud.busy.app/api-tokens). You can provide it in the constructor or at runtime with `setToken`:
...
`StateStream` decodes protobuf for you, so you get ready-to-use typed objects in your callbacks. The worker is bundled inline; no bundler configuration is required on your side.
...
`renderFrame` always expects RGBA bytes. How you get to RGBA depends on where the frame comes from:
...
-   Documentation: [https://docs.busy.app/bar/dev/libraries](https://docs.busy.app/bar/dev/libraries)
-   Source: [https://github.com/busy-app/busylib-ts](https://github.com/busy-app/busylib-ts)
-   npm: [https://www.npmjs.com/package/@busy-app/busy-lib](https://www.npmjs.com/package/@busy-app/busy-lib)

* * *

## License

[MIT](https://github.com/busy-app/busylib-ts/blob/HEAD/LICENSE)
...
[View build summary](https://github.com/busy-app/busylib-ts/actions/runs/28668601818/attempts/1)

Source Commit

[github.com/busy-app/busylib-ts@df4ac5a](https://github.com/busy-app/busylib-ts/tree/df4ac5a4cee84bfd42033abc42d45fe9563e20e8)

Build File

[.github/workflows/publish.yml](https://github.com/busy-app/busylib-ts/actions/runs/28668601818/workflow)

Public Ledger

[Transparency log entry](https://search.sigstore.dev/?logIndex=2062240995)
...
[Gitgithub.com/busy-app/busylib-ts](https://github.com/busy-app/busylib-ts)

### Homepage

[github.com/busy-app/busylib-ts#readme](https://github.com/busy-app/busylib-ts#readme)
...
[0](https://github.com/busy-app/busylib-ts/issues)

### Pull Requests

[0](https://github.com/busy-app/busylib-ts/pulls)
...
-   [![busy.slipn3r](https://www.npmjs.com/npm-avatar/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdmF0YXJVUkwiOiJodHRwczovL3MuZ3JhdmF0YXIuY29tL2F2YXRhci82MmE5Yzg0ODg0ZTczYWRiNDUxNDU2YzEyNjk3NmY4Nz9zaXplPTEwMCZkZWZhdWx0PXJldHJvIn0.TPOHaj1_l0MVZ_p-4K-LKdUWXYK-0lEdLXWNxf3jUzU "busy.slipn3r")](https://www.npmjs.com/~busy.slipn3r)
    
    busy.slipn3r
    
-   [![m.lyubimov](https://www.npmjs.com/npm-avatar/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdmF0YXJVUkwiOiJodHRwczovL3MuZ3JhdmF0YXIuY29tL2F2YXRhci9kMWQwY2Q3Zjc4NDc4ZjFhN2M1NzhiMzA4Mzg2MmI0Nj9zaXplPTEwMCZkZWZhdWx0PXJldHJvIn0.v-HbfI2GlTCcLFp6u1o6HdBxI4o4-uquwXC3uvDUSVQ "m.lyubimov")](https://www.npmjs.com/~m.lyubimov)
    
    m.lyubimov
    

[**Analyze security** with Socket](https://socket.dev/npm/package/%40busy-app%2Fbusy-lib)[**Check bundle size**](https://bundlephobia.com/package/%40busy-app%2Fbusy-lib)[**View package health**](https://snyk.io/advisor/npm-package/%40busy-app%2Fbusy-lib)[**Explore dependencies**](https://npmgraph.js.org/?q=%40busy-app%2Fbusy-lib)

[**Report** malware](https://www.npmjs.com/support?inquire=security&security-inquire=malware&package=%40busy-app%2Fbusy-lib&version=0.17.0)