...
export class TaskRepository {
    ...
    getTasksByProjectId(projectId) {
        ...
        const stmt = this.dbConn.getDb().prepare('SELECT id, project_id as projectId, key, title, status FROM tasks WHERE project_id = ?');
     ...
     */
    createAdHocTask(customTitle, fallbackKey = 'MISC-1') {
        if (!customTitle) {
