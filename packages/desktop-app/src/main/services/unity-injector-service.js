...
export class UnityInjectorService {
     ...
     */
    constructor(customPluginSourcePath) {
    ...
    /// </summary>
    async checkGlobalGitignoreStatus() {
        try {
            const gitignorePath = this.getGlobalGitignorePath();
            if (!fs.existsSync(gitignorePath)) {
    ...
    /// </summary>
    async scanAndInjectProjects(rootFolder) {
    ...
    /// </summary>
    async removeInjection(projectPath) {
     ...
     */
    findUnityProjects(dir, maxDepth) {
        if (maxDepth <= 0)
            return [];
        const projectPaths = [];
        try {
...
//# sourceMappingURL=unity-injector-service.js.map